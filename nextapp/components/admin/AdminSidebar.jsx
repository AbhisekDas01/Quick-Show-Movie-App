                ...
                {adminNavlinks.map((link, index) => {
                    ...
                    return (
                        <Link
                            key={index}
                            href={link.path}
                            className={`relative flex items-center max-md:justify-center gap-2 w-full py-2.5 min-md:pl-10 first:mt-6 text-gray-400 ${isActive ? 'bg-Primary/15 text-Primary' : ''}`}
                        >
