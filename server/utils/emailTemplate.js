    ...
    <main class="content">
      ...
      <div class="card">
        <table style="width:100%;border-collapse:collapse;">
          <tr>
            ...
            <td class="right" style="padding:12px 0;font-weight:700;color:#fff;">${dateTimeText}</td>
          </tr>
          <tr>
            <td style="padding:12px 0;border-top:1px solid #333;font-weight:600;">Theater:</td>
            <td class="right" style="padding:12px 0;border-top:1px solid #333;font-weight:700;color:#fff;">${theaterName || "QuickShow"}</td>
          </tr>
          <tr>
            <td style="padding:12px 0;border-top:1px solid #333;font-weight:600;">Seats:</td>
            <td class="right" style="padding:12px 0;border-top:1px solid #333;font-weight:700;color:#fff;">${seatsText}</td>
          </tr>
        </table>
      </div>
      ...
      <table style="width:100%;border-collapse:collapse;">
        <tr style="font-weight:700;color:#fff;border-top:1px solid #333;">
          ...
          <td class="right" style="padding:16px 0;font-size:20px;">${totalText}</td>
        </tr>
      </table>
    </main>
